...
import '../style.css'
import DisplayAdds from './DisplayAdds';
    ...
    return (
        ...
        <main className={classes.content}>
            <div className={classes.toolbar} />
            <div>
            	<Button variant="outline-dark">Shortlisted</Button>{' '}
            	<Button variant="outline-dark">Contacted</Button>{' '}
            	<Button variant="outline-dark">Scheduled</Button>{' '}
            	<Button variant="outline-dark">Visited</Button>
            </div>
            <br />
            <p>
            	<b>SHORTLISTED</b>
